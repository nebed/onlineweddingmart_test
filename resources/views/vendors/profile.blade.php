                ...
                <div class="card-body">
                  <form>
                    <div class="form-group row">
                      <label for="inputText3" class="col-12 col-sm-3 col-form-label text-sm-right">Input Text</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input id="inputText3" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputPassword3" class="col-12 col-sm-3 col-form-label text-sm-right">Input Password</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input id="inputPassword3" type="password" class="form-control">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputPlaceholder3" class="col-12 col-sm-3 col-form-label text-sm-right">Placeholder Input</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input id="inputPlaceholder3" type="text" placeholder="Placeholder text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputDisabled3" class="col-12 col-sm-3 col-form-label text-sm-right">Disabled Input</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input id="inputDisabled3" type="text" disabled="disabled" placeholder="Disabled input text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputReadonly3" class="col-12 col-sm-3 col-form-label text-sm-right">Readonly Input</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input id="inputReadonly3" type="text" readonly="readonly" value="Readonly input text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputTextarea3" class="col-12 col-sm-3 col-form-label text-sm-right">Textarea</label>
                      <div class="col-12 col-sm-8 col-lg-6">
